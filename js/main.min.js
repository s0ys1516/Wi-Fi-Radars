...
/* harmony import */ var _vendor_testInstruments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/testInstruments */ "./js/vendor/testInstruments.js");
      ...
      Object(_modules_init_modals__WEBPACK_IMPORTED_MODULE_2__["initModals"])(); //-- этот скрипт загружает модуль для тестирования, его не должно быть в финальном билде и на проде для клиента

      window.addEventListener('load', function () {
        Object(_vendor_testInstruments__WEBPACK_IMPORTED_MODULE_3__["testInstruments"])();
      }); //--
...
/* harmony import */ var _utils_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/modal */ "./js/utils/modal.js");
      ...
      var modalAudience = document.querySelector('.modal--audience');
      var modalAudienceBtns = document.querySelectorAll('[data-modal="audience"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
      ...
      var initModals = function initModals() {
        ...
        if (modalAudience && modalAudienceBtns.length) {
          Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalAudience, false, modalAudienceBtns);
        }
      };
...
document.querySelector('.nav-toggle').onclick = function () {
  document.querySelector('.nav-toggle').classList.toggle('nav-toggle--opened');

  document.querySelector('.nav-wrapper').classList.toggle('nav-toggle--opened');
...
document.querySelector('.qanda').onclick = function () {
  document.querySelector('.nav-toggle').classList.toggle('nav-toggle--opened');
